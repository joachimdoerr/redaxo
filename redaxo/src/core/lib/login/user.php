...
class rex_user
{
     ...
     * @psalm-return rex_complex_perm|rex_media_read_perm|null
     * @phpstan-return rex_media_perm|rex_media_read_perm|rex_structure_perm|rex_module_perm|rex_clang_perm|null
     */
